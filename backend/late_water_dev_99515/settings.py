"""
Django settings for late_water_dev_99515 project.
...
ROOT_URLCONF = 'late_water_dev_99515.urls'
...
WSGI_APPLICATION = 'late_water_dev_99515.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "late_water_dev_99515 API",
    "DESCRIPTION": "API documentation for late_water_dev_99515 App",
    "VERSION": "v1",
}
